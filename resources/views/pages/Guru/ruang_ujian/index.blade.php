...
@section('page-title','Ruang Ujian Saya')
@section('content')
<div class="bg-white rounded-xl shadow p-6">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-lg font-semibold text-gray-700">Ruang Ujian Saya</h2>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-3 py-2 space-x-1">
                        ...
                        <form action="{{ route('guru.ruang-ujian.destroy', $r->id) }}" method="POST" class="inline"
                ...
                @empty
                <tr><td colspan="7" class="text-center py-6 text-gray-400">Belum ada ruang ujian.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
...
<div id="modalTambah" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <form action="{{ route('guru.ruang-ujian.store') }}" method="POST">
            @csrf
            <div class="mb-3">
...
function openEdit(id,data,kelasIds){
    document.getElementById('formEdit').action='/guru/ruang-ujian/'+id;
